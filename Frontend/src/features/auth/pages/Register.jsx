            ...
            <div className="w-full max-w-md">
                <div className="bg-gray-800 rounded-lg shadow-2xl border border-gray-700 p-8">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <button className='w-full py-2.5 px-4 bg-blue-600 hover:bg-blue-700 active:scale-95 text-white font-semibold rounded-lg transition transform duration-150 shadow-lg'>Register</button>

                    </form>

                    <p className="mt-6 text-center text-gray-400 text-sm">Already have an account? <Link to="/login" className="text-blue-500 hover:text-blue-400 font-medium transition">Login</Link></p>
                </div>
            </div>
        </main>
    )
